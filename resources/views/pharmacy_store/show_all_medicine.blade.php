...
<body>
    ...
    @foreach($all_medicine_record as $all_medicine_records)

        <div class="col-xs-12 col-md-6 d">
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-12 col-xs-12">
                        <div class="product-image">
                            <img src="pharmacy_medicine/{{$all_medicine_records->image}}" class="img-responsive">
                            <span class="tag2 hot">
                                HOT
                            </span>
                        </div>
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12">
                        <div class="product-deatil">
                            <h3 class="name">
                                <span>{{$all_medicine_records->name}}</span>

                            </h3>
                            <span>{{$all_medicine_records->category}}</span>

                            <p class="price-container">
                                <span>${{$all_medicine_records->price}}</span>
                            </p>
                            <span class="tag1"></span>
                        </div>
                        <div class="description">
                            <h5>Manufacturer</h5>
                            <p>{{$all_medicine_records->manufacturer}}</p>
                        </div>
                        <div class="product-info smart-form">
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{url('add_to_cart_url',$all_medicine_records->id)}}" class="btn btn-danger">Add to cart</a>
                                    <a href="medicine/detail/{{$all_medicine_records->id}}" class="btn btn-info">More info</a>
                                </div>
