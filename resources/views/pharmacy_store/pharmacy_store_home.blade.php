...
<body>
    <div class="hero_area">
        ...
        <header style="background-color: white;" class="header_section">
                    ...
                    <div class="item">
                        ...
                        <div class="box">
                            <div class="btn_container">
                                <form id="GFG" method="POST" action="add_to_cart_and_order_page">
                                    @csrf
                                    <input name="product_id" hidden value="{{$medicine_record->id}}" type="text">
                                    <!-- <button title="Add To Cart" class="" type="submit">
                                        Add To cart
                                    </button> -->
                                    <a onclick="myFunction()" id="submit_button" type="submit">
                                        Buy Now
                                    </a>
                            ...
                            <div class="img-box">
                                <a title="Description" style="background: white; border: none;" href="medicine/detail/{{$medicine_record->id}}">
                                    <img height="200px" src="pharmacy_medicine/{{$medicine_record->image}}" alt="">
                                </a>
                            </div>
                            <div class="detail-box">
                                ...
                                <div class="text">
                                    <h6>
                                        {{$medicine_record->name}}
                                    </h6>
                                    <h6 class="price">
                                        <span>
                                            $
                                        </span>
                                        {{$medicine_record->price}}
                                    </h6>
                                </div>
                            </div>
                        </div>
    ...
    <section class="about_section layout_padding">
        <div class="container">
            ...
            <div class="detail-box">
                <p>
                    To provide quality education and training that will lead to the emergence of a qualified academic professional who comes up to the highest professional standards of the chosen specialty and at the same time has developed into a humane, communicative and practical individual
                </p>
                <div class="d-flex justify-content-center">
                    <a href="/about">
                        Read More
    ...
    @auth
    @include('pharmacy_store.contact_section')
    @endauth
    <!-- end contact section -->
